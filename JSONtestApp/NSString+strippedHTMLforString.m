//
//  NSString+strippedHTMLforString.m
//  JSONtestApp
//
//  Created by Lasse Wingreen on 15/01/14.
...
- (NSString*)stripHtml {
    ...
    if((xmlParseError = [parser parserError])) {
        NSLog(@"This is a warning only. There was an error parsing the string to strip HTML. This error may be because the string did not contain valid XML, however the result will likely have been decoded correctly anyway.: %@", xmlParseError);
    }
